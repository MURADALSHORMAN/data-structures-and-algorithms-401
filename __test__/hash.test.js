...
const repeat = require('../JavaScript/hashmap-join');
...
describe('Tests hashmap repeated words', () => {
  ...
  const test3 = 'It was a queer, sultry summer, the summer they electrocuted the Rosenbergs, and I didn’t know what I was doing in Jordan...';
